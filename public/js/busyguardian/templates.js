...
templates['draftGame.hbs'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<a name=\"game-"
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":29,"column":88},"end":{"line":29,"column":94}}}) : helper)))
    + "', this)\">Publish</button>\n                        <button class=\"btn btn-danger\" onclick=\"controller.editGame('"
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":30,"column":85},"end":{"line":30,"column":91}}}) : helper)))
    + "', this)\">Edit</button>\n                    </div>\n                </div>\n\n                <p class=\"card-text\"><small class=\"text-muted\">Last updated "
    + alias4(((helper = (helper = lookupProperty(helpers,"displayUpdatedOn") || (depth0 != null ? lookupProperty(depth0,"displayUpdatedOn") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"displayUpdatedOn","hash":{},"data":data,"loc":{"start":{"line":34,"column":76},"end":{"line":34,"column":96}}}) : helper)))
    + "</small></p>\n            </div>\n        </div>\n    </div>\n</div>";
},"useData":true});
templates['game.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = lookupProperty(helpers,"unless").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"isFull") : depth0),{"name":"unless","hash":{},"fn":container.program(13, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":70,"column":20},"end":{"line":74,"column":31}}})) != null ? stack1 : "");
  ...
  return "                    <button class=\"btn btn-outline-success\" onclick=\"controller.joinGame('"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data,"loc":{"start":{"line":71,"column":90},"end":{"line":71,"column":96}}}) : helper)))
    + "', this)\">\n                        Join\n                    </button>\n";
  ...
  return "<a name=\"game-"
    ...
    + "\n\n                <div class=\"row\" style=\"margin-top: 20px; margin-bottom: 20px\">\n                    <div class=\"col-md-2\"></div>\n                    <div class=\"col-md-10\">\n\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"hasJoined") : depth0),{"name":"if","hash":{},"fn":container.program(10, data, 0),"inverse":container.program(12, data, 0),"data":data,"loc":{"start":{"line":67,"column":20},"end":{"line":75,"column":27}}})) != null ? stack1 : "")
    + "                    </div>\n                </div>\n\n\n                <p class=\"card-text\"><small class=\"text-muted\">Last updated "
    + alias4(((helper = (helper = lookupProperty(helpers,"displayUpdatedOn") || (depth0 != null ? lookupProperty(depth0,"displayUpdatedOn") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"displayUpdatedOn","hash":{},"data":data,"loc":{"start":{"line":80,"column":76},"end":{"line":80,"column":96}}}) : helper)))
    + "</small></p>\n            </div>\n        </div>\n    </div>\n</div>";
},"useData":true});
...
templates['joinedGame.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "                        <button class=\"btn btn-danger\" onclick=\"controller.deleteGame('"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data,"loc":{"start":{"line":64,"column":87},"end":{"line":64,"column":93}}}) : helper)))
    + "', this)\">Delete</button>\n";
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"isConfirmed") : depth0),{"name":"if","hash":{},"fn":container.program(12, data, 0),"inverse":container.program(14, data, 0),"data":data,"loc":{"start":{"line":66,"column":24},"end":{"line":70,"column":31}}})) != null ? stack1 : "")
    + "                        <button class=\"btn btn-outline-danger\" onclick=\"controller.leaveGame('"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":71,"column":94},"end":{"line":71,"column":100}}}) : helper)))
    + "', this)\">Leave</button>\n";
},"12":function(container,depth0,helpers,partials,data) {
    return "                        <button class=\"btn btn-success\" disabled>Confirmed</button>\n";
  ...
  return "                        <button class=\"btn btn-outline-success\" onclick=\"controller.confirmGame('"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data,"loc":{"start":{"line":69,"column":97},"end":{"line":69,"column":103}}}) : helper)))
    + "', this)\">Confirm</button>\n";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.hooks.helperMissing, alias3="function", alias4=container.escapeExpression, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return "<div class=\"game card mb-3\">\n    <div class=\"row no-gutters\">\n        <div class=\"col-md-2\"  style=\"max-width: 100px; margin: auto 0 auto\">\n            <img src=\"/img/activity-"
    ...
    + "\n                    </div>\n                </div>\n                </div>\n\n\n                <div class=\"row\" style=\"margin-top: 20px; margin-bottom: 20px\">\n                <div class=\"col-md-2\"></div>\n                <div class=\"col-md-10\">\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"isOwner") : depth0),{"name":"if","hash":{},"fn":container.program(9, data, 0),"inverse":container.program(11, data, 0),"data":data,"loc":{"start":{"line":63,"column":20},"end":{"line":72,"column":27}}})) != null ? stack1 : "")
    + "\n\n                    <div class=\"btn-group\">\n                    <button type=\"button\" class=\"btn btn-outline-primary dropdown-toggle\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\n                        Add to Calendar\n                    </button>\n                    <div class=\"dropdown-menu\">\n                        <a href=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"googleCalendarUrl") || (depth0 != null ? lookupProperty(depth0,"googleCalendarUrl") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"googleCalendarUrl","hash":{},"data":data,"loc":{"start":{"line":80,"column":33},"end":{"line":80,"column":54}}}) : helper)))
    + "\" class=\"dropdown-item\" target=\"_blank\">Google</a>\n                        <a href=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"outlookCalendarUrl") || (depth0 != null ? lookupProperty(depth0,"outlookCalendarUrl") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"outlookCalendarUrl","hash":{},"data":data,"loc":{"start":{"line":81,"column":33},"end":{"line":81,"column":55}}}) : helper)))
    + "\" class=\"dropdown-item\" target=\"_blank\">Outlook</a>\n                        <a href=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"icsCalendarUrl") || (depth0 != null ? lookupProperty(depth0,"icsCalendarUrl") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"icsCalendarUrl","hash":{},"data":data,"loc":{"start":{"line":82,"column":33},"end":{"line":82,"column":51}}}) : helper)))
    + "\" class=\"dropdown-item\" target=\"_blank\" download=\"TbG-"
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":82,"column":105},"end":{"line":82,"column":111}}}) : helper)))
    + ".ics\">iCal</a>\n                    </div>\n                    </div>\n\n                    \n                </div>\n                </div>\n\n                <p class=\"card-text\"><small class=\"text-muted\">Last updated "
    + alias4(((helper = (helper = lookupProperty(helpers,"displayUpdatedOn") || (depth0 != null ? lookupProperty(depth0,"displayUpdatedOn") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"displayUpdatedOn","hash":{},"data":data,"loc":{"start":{"line":90,"column":76},"end":{"line":90,"column":96}}}) : helper)))
    + "</small></p>\n\n            </div>\n        </div>\n    </div>\n</div>";
},"useData":true});
